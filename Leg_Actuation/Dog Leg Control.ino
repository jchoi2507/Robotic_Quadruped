...
void loop() {
  ...
  if (n == 0){
    ...
    for (int i = 0; i < 30; i++){
      servoR1_1.write(angle1R[i+30]);
      servoR1_2.write(angle2R[i+30]);
      servoR2_1.write(angle1R[i]);
      servoR2_2.write(angle2R[i]); 
      servoL2_1.write(angle1L[i+30]);
      servoL2_2.write(angle2L[i+30]);
    ...
    for (int i = 0; i < 30; i++){
      servoR1_1.write(angle1R[i]);
      servoR1_2.write(angle2R[i]);
      servoR2_1.write(angle1R[i+30]);
      servoR2_2.write(angle2R[i+30]); 
      servoL2_1.write(angle1L[i]);
      servoL2_2.write(angle2L[i]);
      servoL1_1.write(angle1L[i+30]);
      servoL1_2.write(angle2L[i+30]);
      delay(15);
    }
  }
